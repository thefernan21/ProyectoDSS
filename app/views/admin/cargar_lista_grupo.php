<?php
$pageTitle    = 'Cargar lista — ' . htmlspecialchars($grupo['nombre_grupo'] ?? '', ENT_QUOTES, 'UTF-8');
...
<div class="grid-2" style="align-items:start;">
  ...
  <!-- FORMULARIO CARGA CSV -->
  <div class="card">
    <div class="card-header">
      <div>
        <div class="card-title">📂 Cargar lista de alumnos</div>
        <div class="card-subtitle">
          Los alumnos del CSV quedarán inscritos en
    ...
    <div class="alert alert-info" style="margin-bottom:16px;">
      <div>
        ⚠️ <strong>Importante:</strong> Solo puedes agregar alumnos cargando su lista CSV
        vinculada a este grupo. No es posible registrarlos sin asignarlos a una materia.
      </div>
    </div>

    <form action="index.php?accion=procesar_lista_grupo" method="POST" enctype="multipart/form-data">
      ...
      <button type="submit" class="btn btn-primary" style="width:100%;">
        📤 Cargar e inscribir alumnos al grupo
      </button>
    </form>
  </div>

  <!-- GUÍA DE FORMATO + ALUMNOS YA INSCRITOS -->
  <div style="display:flex; flex-direction:column; gap:16px;">
    ...
    <div class="card">
      ...
      <div style="margin-top:12px; display:flex; flex-direction:column; gap:6px; font-size:12px; color:#475569;">
        ...
        <div>🔒 <strong>Contraseña inicial</strong> = número de control</div>
      </div>
    </div>
    ...
    <div class="card">
      <div class="card-header">
        <div class="card-title">👥 Alumnos ya inscritos</div>
    ...
    <div class="card">
      <div style="text-align:center; padding:24px 0; color:#94a3b8;">
        ...
        <p style="font-size:12px; margin-top:4px;">Carga el primer CSV para comenzar.</p>
      </div>
    </div>
    <?php endif; ?>
